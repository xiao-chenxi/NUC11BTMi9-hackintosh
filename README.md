...
- 10-2-2024
  ...
  - `Sonama 14.4-14.X` please download the `NUC11BTMi9-hackintosh-Sonama-V1.2.zip，The final upgrade has been done, `sonoma 14.4-14.X` will no longer be maintained

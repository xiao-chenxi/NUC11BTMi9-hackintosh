...
## Applicable to NUC11BTMi7/i9,Support installation MacOS Sequoia
...
- 10-2-2024
  ...
  - Supports Intel® Wi-Fi 6E AX210, the driver has been added, you only need to use OpenCore-Legacy-Patcher to patch the network card。https://github.com/dortania/OpenCore-Legacy-Patcher
